+(function (e, n, t, r) {
  +(function (i, o, a, c, s, u) {
          ...
          switch (e) {
            ...
            case 38:
              var i = a[H.i],
                ...
                s = 0;
              u[i] && ((o = u[i][0]), (s = u[i][1])),
                (n = m(H, { x: H.x + o, y: H.y + s, i: i })),
                (n.x = r.min(n.x, 10 - c[n.i])),
                (n.x = r.max(n.x, 0));
          }
          (H = g(n) || H), E(), k();
        }
    ...
    function h() {
      ...
      (O += 10 * I), (H = A), (A = m()), (i = w);
      for (var r = 200, o = 10, a = 0, c = 0; (r -= o); )
        i.slice(r, r + o).every(e) &&
          (i.splice(r, o),
          (c += o),
          a < 4 && a++,
          ++x % 10 === 0 && (I = I < 9 ? I + 1 : 1));
      for (; c--; ) i.unshift(0);
      (O += [0, 50, 150, 350, 1e3][a] * I),
        i.some(e) || (O += 2e3 * I),
        (w = i),
        E();
    }
    function k() {
      ...
      if (P)
        return (
          (n = d(" ", 19)),
          (L = [
            -58917640, -942919668, 858981133, -2096247688, -1023360221,
            53509168, -858816512,
          ]
            .map(function (e) {
    ...
    var L,
      ...
      P = 1;
    b(),
      (window.TETRIS = { on: S, pause: p, pressKey: y, start: b, upause: v });
  })(
    "0".repeat(200).split("").map(e),
    [
      785, 23, 547, 116, 51, 114, 305, 39, 562, 15, 4369, 99, 306, 54, 561, 802,
      113, 275, 71,
    ].map(function (n) {
  ...
  +(function () {
    ...
    (r = new (window.AudioContext || window.webkitAudioContext)()),
      ...
      document
        ...
        .addEventListener("click", function (e) {
          (c = !c),
            c ? a && a.stop(0) : (a = n(o, !0)),
            (e.target.innerHTML = c ? "UNMUTE SOUND" : "MUTE SOUND"),
            e.target.blur();
        }),
    ...
    (function () {
      ...
      function r(e, n) {
        function t() {
          (e.innerHTML = "|/-\\".charAt(i) + d.repeat(n)),
            (i = ++i > 3 ? 0 : i);
        }
        var r = e.innerHTML,
          i = 0;
      ...
      function c(i, c, s) {
        function u() {
          t("userboard-send").removeEventListener("click", d),
            t("userboard-close").removeEventListener("click", f),
            (t("userboard").style.display = "none"),
            y(),
            m();
        }
        function f() {
        ...
        (t("userboard").style.display = "block"),
          (t("your-score").innerHTML = n("YOUR SCORE:", e(i.score), 32));
        try {
          var l = new Date().getTime(),
            p = JSON.parse(localStorage.getItem("tetrisScore")) || [];
          p.push({ t: l, s: i.score }),
        ...
        t("name-input").focus(),
          t("userboard-send").addEventListener("click", d),
          t("userboard-close").addEventListener("click", f);
        ...
        function n(n) {
          if (
            !(
              ...
              n.metaKey ||
              n.shiftKey ||
              ((keyCode = n.which > 0 ? n.which : n.keyCode),
              t && keyCode === r)
            )
          ) {
            r = keyCode;
